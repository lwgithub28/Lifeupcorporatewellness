          ...
          <div className='container'>
            <div className='row'>
              <div className='col-lg-6 col-md-12 col-sm-12'>
                <h4 class="h4-head main-head">LifeUp Corporate Wellness: A Professional Perspective</h4>
                <p className='text-desc'>With so much health information out in the world, it's hard to decipher what are true and relevant practices from marketing and snake oils. And if one is lucky enough to find a quality wellness program, how could it be implemented without a laborious onboarding process?
                  <br></br> <br></br>
                  Even with these obstacles to overcome, now is not the time to wait. Lack of exercise, nutrition education, and a disconnect from ourselves and ourcommunities has created an epidemic of chronic disease, and there's a good chance some or much of your workforce has already been afflicted. What's more, the responsibility of companies to support their people through these challenges is reaching a crescendo. A recent survey found that one in two employees would like to see the companies they work for place a greater
                  ...
                  <div className='container'>
                    <div className='row'>
                      <div className='col-md-5 piller-box-img'>
                        <img src={detoxificationImg} alt='Detoxification'>
                        </img>
                      </div>
                      <div className='col-md-7 piller-box-text'>
                        ...
                        <p className='text-desc'>Detoxification is the process of removing toxic substances from the body,
                          ...
                          when an organism returns to homeostasis afte longterm use of an addictive substance.</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className='row'>
                      ...
                      <div className='col-md-7 piller-box-text'>
                        ...
                        <p className='text-desc'>Nutrition is the process by which organisms use food to support their life.
                          Nutrients are substances found in food that the body uses to grow, reproduce, and survive.
                    ...
                    <div className='row'>
                      ...
                      <div className='col-md-7 piller-box-text'>
                        ...
                        <p className='text-desc'>It may seem like there's nothing you can do about stress.
                          ...
                          and your work and family responsibilities will always be demanding.
                    ...
                    <div className='row'>
                      ...
                      <div className='col-md-7 piller-box-text'>
                        ...
                        <p className='text-desc'>Supplements are manufac- tured products that provide nutrients, vitamins,
                          or ingredients that may not be consumed daily or in sufficient quantities.
                  ...
                  <div className='container'>
                    <div className='row'>
                      ...
                      <div className='col-md-7 piller-box-text'>
                        ...
                        <p className='text-desc'>Play can help develop creativity, which is a broad concept that
            ...
            <div className='row conversationHealth-inner'>
              <div className='col-lg-8 col-md-12'>
                {SummitsAndConferences.map((item) => {
                  return <div className='conversationHealthBox' key={item.id}>
                    <div className='img'>
                      <img src={item.img} alt='Facilitator' loading="lazy"></img>
                    </div>
                    <div className='text'>
              ...
              {ChallengesSection.map((item) => {
                return <div className='col-md-4' key={item.id}>
                  <div className='ChallengesBox'>
                    <img src={item.img} alt='IndividualPillars' loading="lazy"></img>
                    <h4 class="h4-head">{item.name}</h4>
                    <p className='text-desc'>{item.description}</p>
                  </div>
                </div>
