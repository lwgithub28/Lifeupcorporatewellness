...
const Home = () => {
    ...
    return (
        <>
            <Helmet>
                <title> Corporate Health Coach Los Angeles - LifeUP Corporate Wellness</title>
                <meta name="description" content="Get the best corporate health and wellness coach in los angeles CA with LifeUP, we specialize in improving workplace, employee wellness & productivity." />
            </Helmet>
            {/* // banner start */}
                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-12 col-lg-4 video-black-section'>
                                <div className='video-black-section-inner'>
                                    ...
                                    <button className="btn transparent-btn" type="submit" onClick={() => openModal('638399892')}>watch video <span className='home-icon'><MdOutlineSlowMotionVideo /></span></button>
                                    {modalOpen && (
                                        <div className="modal-overlay" onClick={closeModal}>
                                            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                                                <span className="modal-close" onClick={closeModal}>&times;</span>
                        ...
                        <div className='row'>
                            <div className='col-md-12 col-lg-6 lifestyleCoachInner'>
                                ...
                                <p class="text-desc">Derek Opperman is a certified Corporate Wellness coach in LA across multiple health disciplines,
                                    ...
                                    <br></br><br></br>
                                    His company LifeUP’s Healthy Habits for the Busy Business program is a transformational, research-backed, comprehensive curriculum delivered in-person, online, or in a hybrid framework.</p>
                                <Link to='/about' >
                    ...
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-lg-5 col-md-12 '>
                                ...
                                <a href='https://lifeupcorporatewellness.com/blog/healthy-employees-thriving-business-unlocking-the-potential-of-wellness/' 
                                            target='_blank'>
                                ...
                                <a href='https://lifeupcorporatewellness.com/blog/healthy-employees-thriving-business-unlocking-the-potential-of-wellness/' 
                                    ...
                                    <div className='blog-right-flex'>
                                        ...
                                        <div className='left-blog-txt'>
                                            ...
                                            <a href='https://lifeupcorporatewellness.com/blog/australia-s-right-to-disconnect-a-leap-forward-in-employee-well-being/' target='_blank'><button className='blog-circle'><GoArrowUpRight /></button></a>
                                        </div>
                                    </div>
                                    </a>
                                </div>
