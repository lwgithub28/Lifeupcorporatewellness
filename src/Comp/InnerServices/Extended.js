            ...
            <section className='for-top-spacing Inner-page' id='extended-page'>
                        ...
                        <div className='row'>
                            <div className='col-lg-7 col-md-12 col-sm-12 LearningSectionText'>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <span target="_blank" className='navbar-top-link chng-align'><img src={checkArrow} alt='checkArrow' loading="lazy"></img>
                                            <h6>Challenges conducted through our private app- just for your employees.</h6>
                                        </span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <span target="_blank" className='navbar-top-link'><img src={checkArrow} alt='checkArrow' loading="lazy"></img>
                                            <h6>Small group or private health coaching calls for participants.</h6>
                                        </span>
                                    </li>
                                    <li>
                                        <span target="_blank" className='navbar-top-link'><img src={checkArrow} alt='checkArrow' loading="lazy"></img>
                                            <h6>High-energy kickoff and closing acknowledgement events.</h6>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                            <div className='col-lg-5 col-md-12 col-sm-12'>
                                <img src={HealthyHabitChallenge} alt='HealthyHabitChallenge' loading="lazy"></img>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id='InternalStretching' className='LearningSection'>
                    <div className='container'>
                        <div className='row'>
                            <div className='col-lg-7 col-md-12 col-sm-12 LearningSectionText'>
                                <h4 className="h4-head main-head">Healthy Habits for the Busy Business Program</h4>
                                <p className='text-desc'>A 12-month transformational corporate wellness program best for
                                    companies ready to
                                    optimize the well-being of their organization.</p>
                                <ul>
                                    <li>
                                        <span className='navbar-top-link chngFont'><img src={checkArrow} alt='checkArrow' loading="lazy"></img>
                                            <h6>Eight foundational pillar workshops (conducted monthly).</h6>
                                        </span>
                                    </li>
                                    <li>
                                        <span target="_blank" className='navbar-top-link'><img src={checkArrow} alt='checkArrow' loading="lazy"></img>
                                            <h6>Access to online coaching program (pillar workshop recordings, blog posts, continuing education content).</h6>
                                        </span>
                                    </li>
                                    <li>
                                        <span target="_blank" className='navbar-top-link chng-align'><img src={checkArrow} alt='checkArrow' loading="lazy"></img>
                                            <h6>Monthly 'Challenge' to put workshop distinctions out in the world and practiced.</h6>
                                        </span>
                                    </li>
                                    <li>
                                        <span target="_blank" className='navbar-top-link'><img src={checkArrow} alt='checkArrow' loading="lazy"></img>
                                            <h6>Private health coaching calls for each employee/participant.</h6>
                                        </span>
                                    </li>
                                    <li>
                                        <span target="_blank" className='navbar-top-link'><img src={checkArrow} alt='checkArrow' loading="lazy"></img>
                            ...
                            <div className='col-lg-5 col-md-12 col-sm-12'>
                                <img src={HealthyHabits} alt='HealthyHabits' loading="lazy"></img>
                            </div>
                        </div>
                        <p className='text-desc'>*Prices assume digital or Los Angeles city-based facilitation; additional
                            travel costs may be incurred for services rendered.
                        </p>
                    </div>
                </section>
