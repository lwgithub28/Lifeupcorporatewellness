            ...
            <div className='row'>
              ...
              <div className='col-lg-8'>
                <div className='DerekSpeakerImgText'>
                  <h4 className="h4-head main-head">LifeUP delivers comprehensive, experiential programs that deliver the ‘a-ha’ moments that transform the wellness of companies, leaving their employees looking, feeling, and performing their very best.</h4>
                  <p className='text-desc'>
                    ...
                    His company LifeUP's Healthy Habits for the Busy Business program is a transformational, research-backed, comprehensive curriculum delivered in-person, online, or in a hybrid framework.<br></br><br></br>
                    Derek is a decorated athlete, all-natural physique competitor, and Fortune 500 speaker who never forgets he was just a middle-class kid with a big head, bad haircut, and bad skin until he discovered health is a choice to make every single day. He acknowledges and speaks to the innernerd in all of us.
          ...
          <div className='container'>
            <div className='row'>
              ...
              <div className='col-md-4'>
                <a href='https://www.facebook.com/people/Lifeup-Corporate-Wellness/61556157465947/' target='_blank'><img src={facebook} alt='facebook' loading="lazy"></img></a>
              </div>
              <div className='col-md-4'>
                <a href='https://www.linkedin.com/company/lifeup-corporate-wellness-llc/' target='_blank'>
            ...
            <div className='row'>
              ...
              <div className='col-lg-7 col-sm-12 col-md-12 podcastConferenceImgtext'>
                ...
                <p className='text-desc'>Derek is the #1 Coaching and Consulting Professional in the industry for having employers and employees experience fulfillment through holistic, comprehensive corporate health and wellness programs.<br></br><br></br>
                  ...
                  From his own origin story of overcoming physical challenges, and a parent needing mental health support, to the 1000's 1:1 clients that have relied on Derek's whole being coaching, his talks will inspire, engage, and motivate your employees from leadership to supporting staff members.</p>
                <a href='https://calendly.com/lifeup-health' target='_blank' rel="noopener noreferrer">
