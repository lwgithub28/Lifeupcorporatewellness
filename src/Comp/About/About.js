                    ...
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-md-7 mission-text'>
                                ...
                                <p class="text-desc">LifeUP designs and delivers wellness programs that teach
                                    companies and employees how to be healthy for life.</p>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-8'>
                                ...
                                <ul>
                                    ...
                                    <li className='promise-list'>
                                        <span><IoArrowRedo /></span>
                                        <p className='text-desc'>Discover and implement healthy habits that benefit you FOR life.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <section id='team'>
                    <div className='container'>
                        ...
                        <div className="row team-row">
                            {
                                team.map((data, id) => (
                                    <div className='col-md-12 col-lg-4 col-xs-12 col-sm-12 team-box ' key={id}>
                                        <div className='container'>
                                            <div className='row'>
                                                <div className='col-md-5'><img src={data.img} alt='dereekOpperman' loading="lazy" ></img></div>
