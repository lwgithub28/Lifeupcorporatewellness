                        ...
                        <div className='col-lg-7 col-md-12 '>
                            ...
                            <div className='before-border-text'>
                                <span>
                                    ...
                                    <p>This exclusive, first-of-its-kind resource in the U.S. offers practical,
                                        step-by-step strategies to enhance employee well-being and productivity.</p>
                                </span>
                            </div>
                            <div className='before-border-text'>
                                <span>
                                    ...
                                    <ul>
                                        <li> <p>Implement proven wellness strategies.</p></li>
                                        <li>  <p>Gain a competitive edge in employee satisfaction.</p></li>
                                        <li> <p>Foster a thriving, health-focused workplace.</p></li>
                                        <li> <p>Start shaping a healthier future for your business.</p></li>
                                    </ul>
                                </span>
                            </div>
                            <a href='/lifecoporateBook.pdf' target="_blank"> <button className="btn yellow-btn black-btn" type="submit" >download now
