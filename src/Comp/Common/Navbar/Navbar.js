            ...
            <div className='navbar-top'>
                <div className='container alltopcontactalllinks'>
                    <div className='topcontactalllinks'>
                        ...
                        <a href='https://maps.app.goo.gl/uKqtJbxuB6MV2jpR7' target='_blank' className='navbar-top-link'><FaMapMarkerAlt />
                            <p> Los Angeles, CA </p>
                        </a>
                    </div>
                    <div className='topcontactsociallinks'>
                        <a href=' https://www.facebook.com/profile.php?id=61556157465947' target='_blank' className='navbar-top-link'><TfiFacebook />
                        </a>
                        <a href='https://www.linkedin.com/company/lifeup-corporate-wellness-llc/' target='_blank' className='navbar-top-link'><TfiLinkedin />
                        </a>
                    ...
                    <div className="container navbar-inner">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <a href='https://calendly.com/lifeup-health' target='_blank'>
                                <button className="btn yellow-btn" type="submit">schedule a call</button>
                            </a>
                        </div>
                    </div>
