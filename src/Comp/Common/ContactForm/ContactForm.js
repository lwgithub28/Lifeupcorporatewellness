                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-lg-6 col-md-12'>
                            <h4 className="h4-head main-head">Join Derek's Online Community!</h4>
                            <form onSubmit={handleSubmit}>
                                    ...
                                    <span className='fullWidth'>
                                        <div className='d-flex-roww-left'>
                                            ...
                                            <select
                                                ...
                                                <option value="Invite Derek to Speak Up">Invite Derek to Speak Up</option>
                                            </select>
                                        </div>
                                ...
                                {emailSent && <p className='email-sent'>Email sent successfully<FaCheck /></p>}
                            </form>
                        </div>
