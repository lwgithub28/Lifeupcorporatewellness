    ...
    <>
      <div className="logo-group">
        <div className="container">
          <div className="row">
            <div className="col-md-3 col-sm-6 col-xs-6 col-lg-3 sm-text-center">
            ...
            <div className="col-md-3 col-sm-6 col-xs-6 col-lg-3 sm-text-center">
              <a
                href="https://www.integrativehealthpractitioner.org/"
                target="_blank"
              >
            ...
            <div className="col-md-3 col-sm-6 col-xs-6 col-lg-3 sm-text-center">
              <a
                href="https://www.nsca.com/certification/cscs/"
                target="_blank"
              >
            ...
            <div className="col-md-3 col-sm-6 col-xs-6 col-lg-3 sm-text-center">
              <a href="https://www.precisionnutrition.com/" target="_blank">
